...
% SOMMARIO
\begin{abstract}
Il presente lavoro si inserisce nel contesto della ricerca sulla definizione di \textit{Linee di Prodotto Software} basate su documenti di requisiti redatti in linguaggio naturale. Le ambiguità presenti in tali documenti possono generare disallineamenti tra le aspettative del cliente e il prodotto finale, causando spesso revisioni non previste degli artefatti e si è notato che un'espressione ambigua può talvolta servire come strumento per posticipare decisioni.
    ...
    Nella presente tesi, sulla base di un prototipo esistente, si è sviluppato uno strumento di elaborazione linguistica in grado di rilevare tali indicatori di variabilità nei documenti di requisiti. Tale strumento, dotato di capacità di analisi lessicale e sintattica, si avvale della libreria \spacy per la sua realizzazione.
